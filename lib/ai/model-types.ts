...
const ModelArray: ModelArrayType[] = [
    ...
    { id: 22, name: 'claude-opus-4-5-20251101', provider: ModelProvider.ANTHROPIC, cachedInputTokenPPM: 0.5, inputTokenPPM: 5, outputTokenPPM: 25, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
