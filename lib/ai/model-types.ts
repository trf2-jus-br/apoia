...
const ModelProviderArray = [
    ...
    { id: 3, name: 'Google', apiKey: 'GOOGLE_API_KEY', apiKeyRegex: /^AI[a-zA-Z0-9_-]{37,40}$/, status: StatusDeLancamento.PUBLICO },
    ...
    { id: 7, name: 'AWS', apiKey: 'AWS_SECRET_ACCESS_KEY', accessKeyId: 'AWS_ACCESS_KEY_ID', region: 'AWS_REGION', apiKeyRegex: /^[a-zA-Z0-9]{40}$/, status: StatusDeLancamento.PUBLICO },
...
const ModelArray: ModelArrayType[] = [
    { id: 21, name: 'gpt-5.5', provider: ModelProvider.OPENAI, cachedInputTokenPPM: 0.5, inputTokenPPM: 5, outputTokenPPM: 30, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    { id: 21, name: 'gpt-5.4-mini', provider: ModelProvider.OPENAI, cachedInputTokenPPM: 0.08, inputTokenPPM: 0.75, outputTokenPPM: 4.5, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    { id: 21, name: 'gpt-5.4-nano', provider: ModelProvider.OPENAI, cachedInputTokenPPM: 0.02, inputTokenPPM: 0.2, outputTokenPPM: 1.25, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    { id: 21, name: 'gpt-5.4', provider: ModelProvider.OPENAI, cachedInputTokenPPM: 0.5, inputTokenPPM: 5, outputTokenPPM: 22.5, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    ...
    { id: 22, name: 'claude-opus-4-8', provider: ModelProvider.ANTHROPIC, cachedInputTokenPPM: 0.5, inputTokenPPM: 5, outputTokenPPM: 25, status: StatusDeLancamento.PUBLICO, clip: 1000, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    { id: 22, name: 'claude-opus-4-5-20251101', provider: ModelProvider.ANTHROPIC, cachedInputTokenPPM: 0.5, inputTokenPPM: 5, outputTokenPPM: 25, status: StatusDeLancamento.PUBLICO, clip: 200, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    ...
    { id: 10, name: 'gemini-3.7-flash', provider: ModelProvider.GOOGLE, cachedInputTokenPPM: 0.075, inputTokenPPM: 0.75, outputTokenPPM: 3.75, status: StatusDeLancamento.PUBLICO, clip: 1000, supportedFileTypes: [FileTypeEnum.PDF, FileTypeEnum.MP3, FileTypeEnum.MP4, FileTypeEnum.WAV, FileTypeEnum.AIFF, FileTypeEnum.AAC, FileTypeEnum.OGG, FileTypeEnum.FLAC], current: true },
    ...
    { id: 8, name: 'deepseek-chat', provider: ModelProvider.DEEPSEEK, cachedInputTokenPPM: 0.028, inputTokenPPM: 0.28, outputTokenPPM: 0.42, status: StatusDeLancamento.EM_DESENVOLVIMENTO, current: true },
    ...
    { id: 21, name: 'azure-gpt-5.5', provider: ModelProvider.AZURE, cachedInputTokenPPM: 0.5, inputTokenPPM: 5, outputTokenPPM: 30, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    { id: 21, name: 'azure-gpt-5.4', provider: ModelProvider.AZURE, cachedInputTokenPPM: 0.5, inputTokenPPM: 5, outputTokenPPM: 22.5, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    { id: 21, name: 'azure-gpt-5.4-mini', provider: ModelProvider.AZURE, cachedInputTokenPPM: 0.08, inputTokenPPM: 0.75, outputTokenPPM: 4.5, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    { id: 21, name: 'azure-gpt-5.4-nano', provider: ModelProvider.AZURE, cachedInputTokenPPM: 0.02, inputTokenPPM: 0.2, outputTokenPPM: 1.25, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    ...
    { id: 22, name: 'aws-us.anthropic.claude-haiku-4-5-20251001-v1:0', provider: ModelProvider.AWS, cachedInputTokenPPM: 0.11, inputTokenPPM: 1.1, outputTokenPPM: 5.5, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    { id: 22, name: 'aws-us.anthropic.claude-3-5-haiku-20241022-v1:0', provider: ModelProvider.AWS, cachedInputTokenPPM: 0.08, inputTokenPPM: 0.8, outputTokenPPM: 4, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
    { id: 22, name: 'aws-us.anthropic.claude-sonnet-4-20250514-v1:0', provider: ModelProvider.AWS, cachedInputTokenPPM: 0.3, inputTokenPPM: 3, outputTokenPPM: 15, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF], current: true },
]
