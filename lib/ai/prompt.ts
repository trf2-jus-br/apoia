...
import prev_apesp_pontos_controvertidos from '@/prompts/prev-apesp-pontos-controvertidos.md'
...
export const internalPrompts = {
    ...
    prev_apesp_pontos_controvertidos: promptDefinitionFromMarkdown('prev_apesp_pontos_controvertidos', prev_apesp_pontos_controvertidos),
