...
Para informações sobre sincronização de prompts de repositórios Git remotos, webhooks, validação em CI/CD e ciclo de vida das origens, consulte [sincronizacao-bibliotecas-remotas.md](sincronizacao-bibliotecas-remotas.md).
