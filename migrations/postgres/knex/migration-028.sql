...
ALTER TABLE ia_prompt ADD COLUMN mode VARCHAR(20) NULL;
UPDATE ia_prompt SET mode = 'JUDICIAL' WHERE mode IS NULL;

ALTER TABLE ia_user_prefs ADD COLUMN mode VARCHAR(20) NOT NULL DEFAULT 'JUDICIAL';
